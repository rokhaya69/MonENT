...
import sn.thiane.mefpai.ent.domain.Commune;
import sn.thiane.mefpai.ent.repository.CommuneRepository;
...
class CommuneResourceIT {
    ...
    public static Commune createEntity(EntityManager em) {
        Commune commune = new Commune().nomCom(DEFAULT_NOM_COM);
        return commune;
    }
    ...
    public static Commune createUpdatedEntity(EntityManager em) {
        Commune commune = new Commune().nomCom(UPDATED_NOM_COM);
        return commune;
    }
    ...
    @Test
    @Transactional
    void checkNomComIsRequired() throws Exception {
        int databaseSizeBeforeTest = communeRepository.findAll().size();
        // set the field null
        commune.setNomCom(null);
    ...
    void getCommune() throws Exception {
        ...
        restCommuneMockMvc
            ...
            .andExpect(jsonPath("$.nomCom").value(DEFAULT_NOM_COM));
    }
    ...
    void putNewCommune() throws Exception {
        ...
        updatedCommune.nomCom(UPDATED_NOM_COM);
    ...
    void fullUpdateCommuneWithPatch() throws Exception {
        ...
        partialUpdatedCommune.nomCom(UPDATED_NOM_COM);
