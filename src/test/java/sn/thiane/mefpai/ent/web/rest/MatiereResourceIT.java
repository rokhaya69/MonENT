...
import sn.thiane.mefpai.ent.repository.MatiereRepository;
...
class MatiereResourceIT {
    ...
    private static final String DEFAULT_INTITULE_MATIERE = "AAAAAAAAAA";
    private static final String UPDATED_INTITULE_MATIERE = "BBBBBBBBBB";
    ...
    public static Matiere createEntity(EntityManager em) {
        Matiere matiere = new Matiere().intituleMatiere(DEFAULT_INTITULE_MATIERE);
        return matiere;
    }
    ...
    public static Matiere createUpdatedEntity(EntityManager em) {
        Matiere matiere = new Matiere().intituleMatiere(UPDATED_INTITULE_MATIERE);
        return matiere;
    }
    ...
    void createMatiere() throws Exception {
        ...
        assertThat(testMatiere.getIntituleMatiere()).isEqualTo(DEFAULT_INTITULE_MATIERE);
    }
    ...
    @Test
    @Transactional
    void checkIntituleMatiereIsRequired() throws Exception {
        int databaseSizeBeforeTest = matiereRepository.findAll().size();
        // set the field null
        matiere.setIntituleMatiere(null);
    ...
    void getAllMatieres() throws Exception {
        ...
        restMatiereMockMvc
            ...
            .andExpect(jsonPath("$.[*].intituleMatiere").value(hasItem(DEFAULT_INTITULE_MATIERE)));
    }
    ...
    void getMatiere() throws Exception {
        ...
        restMatiereMockMvc
            ...
            .andExpect(jsonPath("$.intituleMatiere").value(DEFAULT_INTITULE_MATIERE));
    }
    ...
    void putNewMatiere() throws Exception {
        ...
        updatedMatiere.intituleMatiere(UPDATED_INTITULE_MATIERE);
        ...
        Matiere testMatiere = matiereList.get(matiereList.size() - 1);
        assertThat(testMatiere.getIntituleMatiere()).isEqualTo(UPDATED_INTITULE_MATIERE);
    }
    ...
    void fullUpdateMatiereWithPatch() throws Exception {
        ...
        partialUpdatedMatiere.intituleMatiere(UPDATED_INTITULE_MATIERE);
