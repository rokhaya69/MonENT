...
describe('Inspecteur Management Component', () => {
  let comp: InspecteurComponent;
  let fixture: ComponentFixture<InspecteurComponent>;
  let service: InspecteurService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'inspecteur', component: InspecteurComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(InspecteurComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.inspecteurs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
