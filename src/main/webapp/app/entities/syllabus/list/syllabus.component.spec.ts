...
describe('Syllabus Management Component', () => {
  let comp: SyllabusComponent;
  let fixture: ComponentFixture<SyllabusComponent>;
  let service: SyllabusService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'syllabus', component: SyllabusComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SyllabusComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.syllabi?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
