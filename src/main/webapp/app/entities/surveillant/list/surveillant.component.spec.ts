...
describe('Surveillant Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'surveillant', component: SurveillantComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.surveillants?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
