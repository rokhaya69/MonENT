...
export class SurveillantComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.surveillantService
      ...
      .subscribe({
        next: (res: HttpResponse<ISurveillant[]>) => {
  ...
  protected onSuccess(data: ISurveillant[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/surveillant'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
