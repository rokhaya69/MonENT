...
describe('Directeur Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'directeur', component: DirecteurComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.directeurs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
