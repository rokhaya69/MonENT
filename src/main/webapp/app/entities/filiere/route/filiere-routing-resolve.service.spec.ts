...
describe('Filiere routing resolve service', () => {
  ...
  let resultFiliere: IFiliere | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IFiliere if id is not provided', () => {
      // GIVEN
      ...
      expect(resultFiliere).toEqual(new Filiere());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Filiere })));
      mockActivatedRouteSnapshot.params = { id: 123 };
