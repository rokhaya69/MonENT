...
describe('Apprenant Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'apprenant', component: ApprenantComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.apprenants?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
