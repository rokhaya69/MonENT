...
describe('Seance Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'seance', component: SeanceComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.seances?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
