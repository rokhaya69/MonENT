...
describe('Proviseur Management Component', () => {
  let comp: ProviseurComponent;
  let fixture: ComponentFixture<ProviseurComponent>;
  let service: ProviseurService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'proviseur', component: ProviseurComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ProviseurComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.proviseurs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
