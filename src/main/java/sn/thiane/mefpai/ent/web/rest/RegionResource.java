...
/**
 * REST controller for managing {@link sn.thiane.mefpai.ent.domain.Region}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class RegionResource {
    ...
    public ResponseEntity<Region> partialUpdateRegion(
        ...
        Optional<Region> result = regionRepository
            ...
            .map(existingRegion -> {
                ...
                if (region.getAutreRegion() != null) {
                    existingRegion.setAutreRegion(region.getAutreRegion());
                }
     ...
     */
    @GetMapping("/regions")
    public ResponseEntity<List<Region>> getAllRegions(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
