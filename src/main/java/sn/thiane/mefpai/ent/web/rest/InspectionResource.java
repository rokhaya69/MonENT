...
/**
 * REST controller for managing {@link sn.thiane.mefpai.ent.domain.Inspection}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class InspectionResource {
    ...
    public ResponseEntity<Inspection> partialUpdateInspection(
        ...
        Optional<Inspection> result = inspectionRepository
            ...
            .map(existingInspection -> {
                if (inspection.getNomInspec() != null) {
                    existingInspection.setNomInspec(inspection.getNomInspec());
                }
    ...
    public ResponseEntity<List<Inspection>> getAllInspections(
        ...
        if (eagerload) {
            page = inspectionRepository.findAllWithEagerRelationships(pageable);
        } else {
            page = inspectionRepository.findAll(pageable);
        }
