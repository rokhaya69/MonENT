...
/**
 * REST controller for managing {@link sn.thiane.mefpai.ent.domain.Classe}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ClasseResource {
    ...
    public ResponseEntity<Classe> partialUpdateClasse(
        ...
        Optional<Classe> result = classeRepository
            ...
            .map(existingClasse -> {
                if (classe.getTitre() != null) {
                    existingClasse.setTitre(classe.getTitre());
                }
                if (classe.getNiveauEtude() != null) {
                    existingClasse.setNiveauEtude(classe.getNiveauEtude());
                }
                if (classe.getAutreNiveau() != null) {
                    existingClasse.setAutreNiveau(classe.getAutreNiveau());
                }
    ...
    public ResponseEntity<List<Classe>> getAllClasses(
        ...
        Page<Classe> page;
        if (eagerload) {
            page = classeRepository.findAllWithEagerRelationships(pageable);
        } else {
            page = classeRepository.findAll(pageable);
        }
    ...
    public ResponseEntity<Classe> getClasse(@PathVariable Long id) {
        ...
        Optional<Classe> classe = classeRepository.findOneWithEagerRelationships(id);
